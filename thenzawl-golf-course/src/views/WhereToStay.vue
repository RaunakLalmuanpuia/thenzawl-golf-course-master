<template>
  <div>
    <v-container class="header" fluid>
      <v-img
        height="300"
        src="@/assets/banners/wherestay.jpg"
        class="d-none d-md-flex d-lg-flex"
      >
        <v-row>
          <div class="title-container">
            <v-col md-4 offset="2">
              <div class="my-title-2">Where To Stay</div>
            </v-col>
          </div>
        </v-row>
      </v-img>
      ...
      <div class="d-flex d-md-none">
        ...
        <div class="pageTitle">Where To Stay</div>
      </div>
      <br />
    </v-container>

    <v-container class="stay-container">
      <!-- <Guide /> -->
      <v-row>
        <v-col md="6">
...
export default {
  ...
  methods: {
    getGuide() {
      this.$axios
        .get("/guide/Where To Stay?page=" + this.page)
        .then((res) => {
