<template>
    <div>
        <v-container class="header" fluid>
            <v-img
                height="300"
                src="@/assets/banners/autorick.jpg"
                class="d-none d-md-flex d-lg-flex relative-position"
            >
                <div class="title-container">
                    <v-col style="padding: 0" md-4 offset="2">
                        <div class="my-title-2">Hire Auto-Rickshow</div>
                    </v-col>
                </div>
            ...
            <div class="d-flex d-md-none">
                ...
                <div class="pageTitle">Hire Auto-Rickshow</div>
            </div>
            <br />
        </v-container>
