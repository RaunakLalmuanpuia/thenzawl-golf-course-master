...
export default {
  ...
  methods: {
    ...
    getGuide() {
      ...
      self.show = true;
      self.$axios
        .get("get-guide/" + this.id)
        .then((res) => {
          self.category = res.data.guide.category_id;
          self.title = res.data.guide.title;
          self.address = res.data.guide.address;
          self.contact = res.data.guide.contact;
          self.email = res.data.guide.email;
          self.show = false;
        })
        .catch((err) => {
          self.show = false;
    ...
    update() {
      ...
      this.$axios
        .post("update-guide/" + this.id, formData, {
          headers: {
